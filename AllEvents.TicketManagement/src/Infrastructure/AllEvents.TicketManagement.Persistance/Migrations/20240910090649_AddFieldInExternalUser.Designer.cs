...
namespace AllEvents.TicketManagement.Persistance.Migrations
{
    ...
    [Migration("20240910090649_AddFieldInExternalUser")]
    partial class AddFieldInExternalUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AllEvents.TicketManagement.Domain.Entities.Coupon", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("Coupons", t =>
                        {
                            t.HasCheckConstraint("CK_Coupon_Discount", "(DiscountPercent IS NOT NULL AND FixedDiscountAmount IS NULL) OR (DiscountPercent IS NULL AND FixedDiscountAmount IS NOT NULL)");
                        });
                });
            ...
            modelBuilder.Entity("AllEvents.TicketManagement.Domain.Entities.ExternalUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AllEvents.TicketManagement.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("AllEvents.TicketManagement.Domain.Entities.Order", null)
                        .WithMany()
